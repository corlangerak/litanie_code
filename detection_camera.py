...
class myCamera:
    def __init__(self):
        self.stats = {}
        self.number_faces = str(0)

    def  run_in_loop(self):
        print("Start run_in_loop")
        ...
        with dai.Device() as device:
            ...
            while True:
                # print("Debug: dit is self.age en self.number_faces", self.number_faces)
                ...
                if msgs is not None:
                    ...
                    number_faces = str(len(detections))
                    ...
                    for i, detection in enumerate(detections):
                        ...
                        gender_str = "vrouw" if gender[0] > gender[1] else "man"

                        stats[i] = {}
                        stats[i]['age'] = age
                        stats[i]['gender'] = gender_str
...
#     age, gender, number_faces = camera()

#     p1 = mp.Process(target=speech(age, 'C:/Users/Gebruiker/Documents/litanie/models_voice/checkpoint_70000.pth'))
